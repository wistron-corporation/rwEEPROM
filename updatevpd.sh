...
printf "\n > Get BMC MAC1 addresses via REST command."
...
printf "\n > Get PartNumber via BMC's REST command."
...
printf "\n > Get SerialNumber via BMC's REST command."
...
printf "\n > Get Original PrettyName via BMC's REST command."
...
### Write data(MAC0, MAC1, PN, SN) to XML files ###
...
### Create binary of VPD format ###
echo -e " > Creating a binary of VPD format\n ---------------------------------"
./usr/bin/write-eeprom
echo -e " ---------------------------------"

### Write VPD binary to EEPROM ###
printf " > Write the binary to EEPROM..."
echo /home/root/eeprom > /sys/bus/i2c/devices/8-0050/eeprom
